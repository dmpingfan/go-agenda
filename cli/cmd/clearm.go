...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		if currentUser == "" {
			AgendaLog.OperateLog("[error]", "clearm error => "+"not login")
			return
		}
		Meeting.ClearAllUserMeeting(currentUser)
		fmt.Println("You have cleared all your meetings")
		AgendaLog.OperateLog("[info]", "clear all your meetings successflly")
	},
}
